    ...
    <body>
        ...
        <div class="container" style="width: 58%; height: 570px">
            ...
            <form class="form" id="myForm" action="editar_alumno.php" method = "post" enctype="multipart/form-data" style=" width: 300px">
                ...
                $sql = "SELECT nombre, apellidos, fecha_nacimiento, curso_id, nota, foto FROM alumno WHERE id=".$_GET['id'];
                ...
                <div class="botones_mostrar" style=" width: 185px;">
                    <a href="formulario_alumno.php"  class="nounderline" ><input title="Volver a formulario" type="button" value="Formulario de alumnos" name="submit" 
