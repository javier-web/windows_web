...
<html lang="es">
    ...
    <body>
        ...
        <div class="container" style="width: 58%; height: 570px">
            ...
            <form class="form" id="myForm" action="modificar_alumno.php" method = "post" enctype="multipart/form-data">
                ...
                foreach ($columnas as $clave => $columna) {
                    if ($clave == 'nombre') {
                        ...
                        echo '<input class = "form-control" type = "date" name = "fecha_nacimiento" value = "' . $columna . '" >';
                        echo '</div>';
                        ...
                        echo '<div class = "editar-foto-alumno">';
                            echo'<img src="uploads/' . $columna . '" id="fotografia">';
                        echo '</div>';
                    } else {
                ...
                <div class="botones_editar" style=" width: 185px;">
                    ...
                    <a href="modificar_alumno.php"  class="nounderline">
                        <input title="Modifica datos de alumno" type="submit" value="Modifica datos de alumno" name="submit"  style="color:black ">
                    </a> 
