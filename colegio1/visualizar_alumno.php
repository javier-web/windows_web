...
<html lang="es">
    ...
    <body>
        ...
        <div class="container" style="width: 58%; height: 570px">
            ...
            <form class="form" id="myForm" action="eliminar_alumno.php" method = "post" enctype="multipart/form-data">
                ...
                //$sql = "SELECT nombre, apellidos, fecha_nacimiento, curso_id, nota, foto, id FROM alumno WHERE id=$columna";
                ...
                foreach ($columnas as $clave => $columna) {
                    if ($clave == 'nombre') {
                        ...
                        echo '<input class = "form-control" type = "date" name = "fecha_nacimiento" value = "' . $columna . '"  disabled>';
                        echo '</div>';
                        ...
                        echo '<option value = "" disabled>Seleccionar&nbsp</option>';
                        ...
                        echo '<input id="identificador" name = "' . $clave . '" value = "' . $columna . '" >';
                        
                    }
                }
                ?>

                <div class="botones_visualizar" style=" width: 185px;">
                    ...
                    <a href="eliminar_alumno.php?id=" <?php echo $_GET['id'] ?> class="nounderline eliminar">
                        <input title="Elimina datos de alumno" type="submit" value="Elimina datos de alumno" name="submit"  style="color:black">
                    </a>
                </div>  
